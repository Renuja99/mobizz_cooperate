...
import AboutImage01 from '@/public/about-grid-01.jpg'
import AboutImage02 from '@/public/img3.png'
import AboutImage03 from '@/public/img7.jpg'
import AboutImage04 from '@/public/img8.jpg'
import AboutImage05 from '@/public/img9.jpg'
import AboutImage06 from '@/public/about-grid-06.jpg'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="text-3xl lg:text-6xl font-sans mb-4">We help teams by delivering the perfect tools</h2>
          ...
          <div className="grid grid-cols-12 gap-3 mt-12 md:mt-20" data-aos-id-gallery>
            ...
            <Image className="col-span-3 bg-green rounded-2xl" src={AboutImage02}  alt="About grid 02" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="100" width={270} height={270}/>
            <Image className="col-span-5 rounded-2xl object-contain" src={AboutImage03} width={450}  height={200} alt="About grid 03" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="200" />
            <Image className="col-span-3 rounded-2xl" src={AboutImage04} width={270} height={270} alt="About grid 04" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="300" />
            <Image className="col-span-5 rounded-2xl" src={AboutImage05} width={450} height={270} alt="About grid 05" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="400" />
            <Image className="col-span-4 rounded-2xl" src={AboutImage06} width={360} height={270} alt="About grid 06" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="500" />
          </div>
