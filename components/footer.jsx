...
export default function Footer() {
  return (
    <footer className="relative">
      {/* Bg */}
      <div className="absolute inset-0 bg-gray-900 -z-10 font-sans" aria-hidden="true" />

      {/* Illustration */}
      {/* <div className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none -z-10" aria-hidden="true">
        <Image className="max-w-full" src={Illustration} alt="Illustration" />
      </div> */}

      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Blocks */}
        <div className="grid sm:grid-cols-12 lg:grid-cols-10 gap-8 py-8 border-t border-gray-100">
          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-2 lg:max-w-xs">
            {/* Logo */}
            <Link className="block group" href="/" aria-label="Mobizz">
        ...
        <div className="md:flex md:items-center md:justify-between pb-4 md:pb-8">
          ...
          {/* Copyrights */}
          <div className="text-sm text-blue-300">© Mobizz.com. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
