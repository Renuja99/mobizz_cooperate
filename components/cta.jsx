...
import Illustration from '@/public/cta-illustration.svg'

export default function Cta() {
  return (
    <section className="relative overflow-hidden ">
      {/* Bg */}
      <div className="absolute inset-0 bg-gray-900 pointer-events-none -z-10" aria-hidden="true" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-5xl font-sans font-semibold tracking-wide leading-relaxed text-white mb-6" data-aos="fade-up">
